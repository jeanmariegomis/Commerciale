        ...
        <div class="form-group">
          ...
          <input
            ...
            :class="{
              ...
              'is-valid': !$v.article.unite.$invalid && $v.article.unite.$dirty,
            }"
          />
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <input
            ...
            :class="{
              ...
              'is-valid':
                !$v.article.quantite.$invalid && $v.article.quantite.$dirty,
            }"
          />
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <select
            ...
            :class="{
              ...
              'is-valid':
                !$v.article.fk_famille.$invalid && $v.article.fk_famille.$dirty,
            }"
          >
