    ...
    public function __construct()
    {
        $this->middleware('auth');
           ...
           public function store(Request $request){
            ...
            //     'raison_sociale_comp' => 'required|unique:macompagnies',
            //     'nom_societe_comp' => 'required|max:60|alpha',
            //     'RC_comp' => 'required|max:60|alpha',
            //     'IF_comp' => 'required|numeric',
            //     'patente_comp' => 'required|numeric',
            //     'cnss_comp' => 'required|numeric',
            //     'ICE_comp' => 'required|numeric',
            //     'capitale_comp' => 'required|numeric',
            //     'taille_comp' => 'required|alphamax:60|alpha',
            //     'secteur_activite_comp' => 'requiredmax:60|alpha',
            //     'nom_bank_comp' => 'required|max:60|alpha',
            //     'RIB_comp' => 'required|numeric',
            //     'adresse_comp' => 'required|max:120',
            //     'email_comp' => 'required|email|max:255|unique:macompagnies',
            //     'GSM_comp' => 'required',
            //     'fix_comp' => 'required|numeric',
            //     'fax_comp' => 'requirednumeric',
            //     'webSite_comp' => 'required',
